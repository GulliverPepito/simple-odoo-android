...
public class TasksAdapter extends RecyclerView.Adapter<TasksAdapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View v) {
            ...
            mTextTaskTitle = (TextView)v.findViewById(R.id.textTitle);
            mTextTaskID = (TextView)v.findViewById(R.id.textID);
        }
    }

    public TasksAdapter(JSONArray jsonDataset, View.OnClickListener onClickListener, Integer months) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        try {
            ...
            if (jsonObj != null) {
                ...
                holder.mTextTaskTitle.setText(jsonObj.getString("name"));
                holder.mTextTaskID.setText("#" + ((Integer) jsonObj.getInt("id")).toString());
                holder.mTextProjectLetter.setBackgroundColor(EiquiUtils.generateColorRandom(ascii));

                if (EiquiUtils.compareDateToday(jsonObj.getString("date_start"), Calendar.MONTH, -mMonths) >= 0) {
